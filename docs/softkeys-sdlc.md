...
**Status:** Amendment A3 (`Del` key) delivered as CR-20 — M11 + M12 complete, `v1.2.1` package built and verified (selftest 208/208), **not released**: local commit only, no tag, no push, no GitHub Release. Gate C1 passed (T-19 witnessed by the Approver). v1.2.0 remains the released version. v1.1.0 released 2026-07-21; v1.0.0 released 2026-07-21. GitHub is the sole remote and canonical history per CR-17 + addendum (cgit archive deleted).
