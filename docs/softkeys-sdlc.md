...
**Status:** v1.1 (A1) — Gate A1 approved 2026-07-21; M7 complete. M8 on HOLD at the Gate A2 launch check (DF-01, armed Alt+F4). Gate A0 approved 2026-07-21 (CR-16, `docs/softkeys-v1.1-amendment.md`). v1.0.0 released and tagged; GitHub is the sole remote of record per CR-17.
