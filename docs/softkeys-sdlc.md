...
**Status:** Released — v1.2.0 (2026-07-22, Gate B2 + final acceptance; tag `v1.2.0`). Amendment A2 delivered in full. v1.1.0 released 2026-07-21; v1.0.0 released 2026-07-21. GitHub is the sole remote and canonical history per CR-17 + addendum (cgit archive deleted).
