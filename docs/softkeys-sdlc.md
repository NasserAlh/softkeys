...
**Status:** **Released — v1.2.1** (2026-07-27, Gate C2). Amendment A3 (`Del` key) delivered in full per CR-20: M11 (F-21 + amended F-04, selftest 208/208) and M12 (package + GitHub Release). v1.2.0 released 2026-07-22; v1.1.0 released 2026-07-21; v1.0.0 released 2026-07-21. GitHub is the sole remote and canonical history per CR-17 + addendum (cgit archive deleted).
