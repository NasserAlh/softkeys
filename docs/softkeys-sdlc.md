...
**Status:** v1.2 (A2) — M9 implementation complete; Gate B1 in progress: T-14 passed, DF-02 withdrawn, T-15 re-run (Enter-press check) + T-16/T-17/T-18 pending, then Gate B1 sign-off and M10. v1.1.0 released 2026-07-21 (Gate A2 + final acceptance). GitHub is the sole remote and canonical history per CR-17 + addendum (cgit archive deleted).
