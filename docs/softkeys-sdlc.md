...
**Status:** v1.2 (A2) — Gate B1 passed 2026-07-22 (T-14–T-18 witnessed; tagged `m9-icon-installer`); M10 in progress: v1.2.0 release prepared, launch check pending. v1.1.0 released 2026-07-21 (Gate A2 + final acceptance). GitHub is the sole remote and canonical history per CR-17 + addendum (cgit archive deleted).
